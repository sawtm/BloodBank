...
public class BloodModel extends ArrayAdapter<AddEntry> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView textViewName =  listViewItem.findViewById(R.id.mtext);
        TextView textViewGenre =  listViewItem.findViewById(R.id.mDate);
        TextView textViewTag =  listViewItem.findViewById(R.id.Tags);
